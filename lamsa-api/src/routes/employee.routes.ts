...
router.post(
  ...
  validate([
    ...
    body('title_ar').optional().isString().trim().withMessage('Arabic title must be a string'),
    body('title_en').optional().isString().trim().withMessage('English title must be a string'),
