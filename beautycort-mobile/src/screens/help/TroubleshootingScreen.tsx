  ...
  const troubleshootingGuides: TroubleshootingGuide[] = [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Go to Settings > Apps > BeautyCort > Storage > Clear Cache & Clear Data.',
          descriptionAr: 'اذهب إلى الإعدادات > التطبيقات > بيوتي كورت > التخزين > امسح الذاكرة المؤقتة والبيانات.',
          action: {
            type: 'navigate',
            target: 'app_settings',
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Go to phone Settings > Apps > BeautyCort > Notifications and enable all.',
          descriptionAr: 'اذهب إلى إعدادات الهاتف > التطبيقات > بيوتي كورت > الإشعارات وفعّل الكل.',
          action: {
            type: 'navigate',
            target: 'app_settings',
        ...
        },
        {
          ...
          description: 'Go to Settings > Battery > Battery Optimization > BeautyCort > Don\'t Optimize.',
          descriptionAr: 'اذهب إلى الإعدادات > البطارية > تحسين البطارية > بيوتي كورت > لا تحسن.',
          action: {
            type: 'navigate',
    ...
    switch (step.action.type) {
      ...
      case 'external':
        ...
        if (step.action.target === 'play_store') {
          Linking.openURL('market://details?id=com.beautycort.app');
