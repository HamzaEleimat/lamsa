...
export const generateShareContent = (
  ...
  const baseContent: ShareContent = {
    ...
    message: '',
    url: profileUrl,
    hashtags: ['BeautyCort', 'BeautyJordan', cityName.replace(/\s+/g, '')],
  };
...
export const generateProviderDeepLink = (
  ...
  const baseUrl = 'beautycort://provider/';
  const webUrl = 'https://beautycort.com/provider/';
