...
export default function ProviderMetaTags({
  ...
  useEffect(() => {
    ...
    const updateMetaTags = () => {
      ...
      // Update page title
      document.title = `${businessName} - Lamsa ${provider.city}`;
      ...
      setMetaTag('author', 'Lamsa');
      setMetaTag('robots', 'index, follow');
      setMetaTag('language', language);

      // Open Graph meta tags
      setMetaTag('og:title', `${businessName} - Lamsa`, true);
      ...
      setMetaTag('og:image', provider.coverImageUrl || provider.avatarUrl || 'https://lamsa.com/images/default-salon.jpg', true);
      setMetaTag('og:site_name', 'Lamsa', true);
      ...
      setMetaTag('twitter:title', `${businessName} - Lamsa`);
      setMetaTag('twitter:description', description || `Beauty services in ${provider.city}. Book your appointment now!`);
      setMetaTag('twitter:image', provider.coverImageUrl || provider.avatarUrl || 'https://lamsa.com/images/default-salon.jpg');
      setMetaTag('twitter:site', '@lamsa');
      ...
      setMetaTag('al:ios:url', `lamsa://provider/${provider.id}`);
      setMetaTag('al:android:package', 'com.lamsa.app');
      setMetaTag('al:android:url', `lamsa://provider/${provider.id}`);
    ...
    return () => {
      ...
      document.title = 'Lamsa - Beauty at Your Fingertips';
    };
...
export const useProviderShareMetadata = (
  ...
  return {
    ...
    url: profileUrl,
    hashtags: ['Lamsa', 'BeautyJordan', businessName.replace(/\s+/g, '')],
    via: 'lamsa',
  };
};