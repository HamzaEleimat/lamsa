    ...
    switch (action) {
      case 'whatsapp':
        ...
        const message = encodeURIComponent(
          `مرحباً! أحتاج مساعدة في تطبيق لمسة.\nHello! I need help with Lamsa app.\n\nProvider ID: ${user?.id || 'N/A'}`
        );
      ...
      case 'email':
        const emailUrl = `mailto:support@lamsa.com?subject=${encodeURIComponent('Lamsa Support Request')}&body=${encodeURIComponent(`Provider ID: ${user?.id || 'N/A'}\n\nPlease describe your issue:\n\n`)}`;
