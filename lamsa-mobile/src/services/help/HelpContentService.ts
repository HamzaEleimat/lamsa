  ...
  private generateDefaultHelpContent(): HelpContent[] {
    return [
      // Getting Started Content
      {
        ...
        title: 'Welcome to Lamsa',
        titleAr: 'أهلاً بك في لمسة',
        content: 'Complete guide to getting started with your beauty business on Lamsa platform.',
        contentAr: 'دليل شامل للبدء بعملك في مجال الجمال على منصة لمسة.',
