...
class VideoService {
  ...
  private initializeVideoContent() {
    ...
    this.videos = [
      {
        id: 'welcome-to-lamsa',
        title: 'Welcome to Lamsa - Complete Overview',
        titleAr: 'أهلاً بك في لمسة - نظرة شاملة',
        description: 'Complete introduction to Lamsa platform for beauty providers in Jordan.',
        descriptionAr: 'مقدمة شاملة لمنصة لمسة لمقدمي خدمات الجمال في الأردن.',
        ...
        transcription: {
          ar: 'أهلاً وسهلاً بك في لمسة، المنصة الرائدة لخدمات الجمال في الأردن...',
          en: 'Welcome to Lamsa, the leading beauty services platform in Jordan...',
        },
        ...
        relatedHelpContent: ['welcome-to-lamsa', 'setup-profile'],
      },
      {
        id: 'setup-profile',
        ...
        difficulty: 'beginner',
        prerequisites: ['welcome-to-lamsa'],
        viewCount: 1876,
        likes: 145,
        downloadSize: 72,
        quality: 'hd',
    ...
    this.playlists = [
      {
        ...
        description: 'Everything you need to start your beauty business on Lamsa',
        descriptionAr: 'كل ما تحتاجه لبدء عملك في مجال الجمال على لمسة',
        videoIds: ['welcome-to-lamsa', 'setup-profile', 'service-creation-guide', 'whatsapp-business-setup'],
