...
This document provides comprehensive testing strategies, test cases, and automation guidelines for the Lamsa mobile provider onboarding flow.
...
module.exports = {
  ...
  apps: {
    ios: {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Debug-iphonesimulator/Lamsa.app',
    },
    android: {
      type: 'android.apk',
